...
description: React + TypeScript conventions — named exports, Props interface, no business logic in components, services as pure TS, hooks for side effects only, avoid any, shared models.ts
---
