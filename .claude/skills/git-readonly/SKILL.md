---
name: git-readonly
description: Restricts git usage to read-only, inspection commands — diff, log, branch listing, status. Load this skill whenever the user asks to look at git history, diffs, branches, or status without intending to change the working tree or repo state.
---
